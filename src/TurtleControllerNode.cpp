...
TurtleControllerNode::TurtleControllerNode() : Node("turtle_controller"), name_("turtle1"), turtlesim_up_(false)
    {
...
void TurtleControllerNode::callbackPose(const turtlesim::msg::Pose::SharedPtr pose)
    {
        pose_ = *pose.get();
        turtlesim_up_ = true;
    }

double TurtleControllerNode::getDistanceFromCurrentPose(my_robot_interfaces::msg::Turtle turtle)
    {
...
void TurtleControllerNode::callbackTurtlesToCatch(const my_robot_interfaces::msg::TurtleArray::SharedPtr msg)
    {
...
void TurtleControllerNode::publishCmdVel(double x, double theta)
    {
...
void TurtleControllerNode::callCatchTurtleService(std::string turtle_name)
    {
